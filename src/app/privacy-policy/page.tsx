        ...
        <div id="aria-font">
          ...
          <ul className="list-inside list-disc space-y-[4px] pb-[1em]">
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              ...
              analytics or advertising cookies and read no measurement identifiers until you accept
              through the cookie consent banner, wherever in the world you are — until then only
              aggregate, cookieless measurement takes place. Session recording (Microsoft Clarity)
              and marketing (Meta Pixel) load only after you opt in. You can withdraw consent at any
              time via the site&apos;s Cookie Preferences control (shown in the footer once the
              consent banner is enabled); this site then deletes the tracking cookies it set,
              Google&apos;s tags return to the cookieless state, and Clarity and the Meta Pixel stop
              loading from your next page view. While this site remains a pre-launch placeholder, no
              Google tags are loaded at all.
            </li>
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
